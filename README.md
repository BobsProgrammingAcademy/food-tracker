...
This is a food-tracking application built using **Django 4**, **HTML 5**, **CSS 3**, and **Bootstrap 5.1.3** with a **Bootswatch** theme. The application uses a **PostgreSQL** database to store data. Charts are built using **Chart.js 2.8.0**.
